...
void displayLED_YELLOW(int IS_ON, int index){
	switch (index){
	case 0:
		if (IS_ON == 1) HAL_GPIO_WritePin(PORTYPE_A, PIN_YELLOW_1, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(PORTYPE_A, PIN_YELLOW_1, GPIO_PIN_RESET);
		break;

	case 1:
		if (IS_ON == 1) HAL_GPIO_WritePin(PORTYPE_A, PIN_YELLOW_2,GPIO_PIN_SET);
		else HAL_GPIO_WritePin(PORTYPE_A, PIN_YELLOW_2, GPIO_PIN_RESET);
		break;
	}
}
...
void displayLED_RED(int IS_ON, int index){
	switch (index){
	case 0:
		if (IS_ON == 1) HAL_GPIO_WritePin(PORTYPE_A, PIN_RED_1, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(PORTYPE_A, PIN_RED_1, GPIO_PIN_RESET);
		break;

	case 1:
		if (IS_ON == 1) HAL_GPIO_WritePin(PORTYPE_A, PIN_RED_2, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(PORTYPE_A, PIN_RED_2, GPIO_PIN_RESET);
		break;
	}
}
...
void displayLED_GREEN(int IS_ON, int index){
	switch (index){
	case 0:
		if (IS_ON == 1) HAL_GPIO_WritePin(PORTYPE_A, PIN_GREEN_1, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(PORTYPE_A, PIN_GREEN_1, GPIO_PIN_RESET);
		break;

	case 1:
		if (IS_ON == 1) HAL_GPIO_WritePin(PORTYPE_A, PIN_GREEN_2, GPIO_PIN_SET);
		else HAL_GPIO_WritePin(PORTYPE_A, PIN_GREEN_2, GPIO_PIN_RESET);
		break;
	}
}
...
void displayLED7SEG_LEFT(int number){
	...
	HAL_GPIO_WritePin(PORTYPE_A, PIN_INP_SEG1_0, arr_2[3]);
	HAL_GPIO_WritePin(PORTYPE_A, PIN_INP_SEG1_1, arr_2[2]);
	HAL_GPIO_WritePin(PORTYPE_A, PIN_INP_SEG1_2, arr_2[1]);
	HAL_GPIO_WritePin(PORTYPE_A, PIN_INP_SEG1_3, arr_2[0]);
}
